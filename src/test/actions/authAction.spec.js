...
import { register, loading, signupFailure, signupSuccess, logoutUser } from '../../actions/authAction';
...
describe('authActions', () => {
  it('should dispatch loading and signupSuccess on succesful signup', () => {
